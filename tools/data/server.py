...
# Make repo-root shared/ importable regardless of CWD (systemd runs us from the
# tool dir), then load the shared Google-OAuth provider used by every public server.
